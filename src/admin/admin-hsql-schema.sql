...
create table lazy_users(
	...
	InfoUser varchar(2000),
	com varchar(2000),
	pwd varchar(2000),
	admin varchar(12), -- ADMIN => super user
...
create table lazy_RoleNode(
	...
	NodeId varchar(100)not null, -- either PROJECT.NODE or PROJECT.*
	TypeId varchar(12)not null,  -- LAZY => instantiate a node, TABLE => update database table
	Display varchar(12), -- ON MENU => display this node in the main menu
	Seq integer , -- display order
	lib varchar(100), -- text to display
	primary key( roleid,nodeid,typeid)
);
 
create table lazy_grants (
	userid varchar(12) not null,
	grpid varchar(12)not null, -- use '*' to grand this role to this user in all dataspaces 
	roleid varchar(12)not null,
...
create table lazy_projects(
	...
	xslurl varchar(200), 
	cssurl varchar(200), 
	bkgndurl varchar(2000)
);

create table lazy_connects(
	connectId varchar(12) primary key,
	com varchar(2000),

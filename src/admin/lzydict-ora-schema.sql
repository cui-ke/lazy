-- for oracle
--
drop table lazy_nodes;
drop table lazy_naturals;
drop table lazy_node_db_dep;
drop table lazy_actions;
--
-- table to store all the node definitions
--
...
--
-- a table with "all" the natural numbers (including 0)
--
